  ...
  return (
    <div className='scene'>
      ...
      <div className='collapse-container'>
        <Collapse className="collapse collapseapropos" title={'Fiabilité'}>
        ...
        <Collapse className="collapse collapseapropos"  title={'Respect'}>
        ...
        <Collapse className="collapse collapseapropos" title={'Service'} >
        ...
        <Collapse className="collapse collapseapropos" title={'Sécurité'} >
